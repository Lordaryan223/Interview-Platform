...
function SessionPage() {
  ...
  const handleEndSessions=()=>{
    ...
    if(confirm("Are you sure you want to end this session, all participants will be notified ") ){
      ...
      endSessionMutation.mutate(session._id,{onSuccess:()=>navigate("/dashboard")})
    }
              ...
              <PanelGroup direction='vertical'>
                <Panel defaultSize={50} minSize={10}>
                  ...
                  className='bg-base-200  h-full overflow-y-auto'>
                    <div
                    className='bg-base-100 p-6 border-b border-base-100'>
                      {/* HEADER SECTION */}
  ...
  <div>
                      ...
                      <div className="flex items-center gap-3">
                        <span
                          className={`badge badge-lg ${giveDifficultyBadgeClass(
                            session?.difficulty
                          )}`}
                        >
                   ...
                   {/* examples section */}
                    ...
                    <PanelResizeHandle className='h-2 bg-base-300hover:transition-colors cursor-col-resize' />
            ...
            <PanelResizeHandle className='h-2 bg-base-300hover:transition-colors cursor-col-resize' />
            <Panel defaultSize={50} minSize={17}>
                <OutputPanel
                output={output}/>
            </Panel>
